...
$(function () {
	...
	function initPostEditor(elem) {
		var endPoint = 'https://qa.syslabo.com/upload/image';
		var mde = new EasyMDE({
			element: elem,
	...
	qfb.click(function () {
		if (localStorage.getItem("questionFilterOpen")) {
			...
			$(this).removeClass("grey darken-2 white-text").blur().children("i").removeClass("fa-times").addClass("fa-gear");
		} else {
			localStorage.setItem("questionFilterOpen", true);
			$(this).addClass("grey darken-2 white-text").children("i").removeClass("fa-gear").addClass("fa-times");
		}
	});
     ...
     ****************************************************/
	$(function(){
		$("input[name='comment']"). keydown(function(e) {
